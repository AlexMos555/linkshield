...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${domain} Privacy Audit — LinkShield`,
    ...
    openGraph: {
      ...
      description: `How much data does ${domain} collect? Find out with LinkShield.`,
      url: `https://linkshield.io/audit/${domain}`,
    },
  };
}
    ...
    <div style={{ background: "#0f172a", color: "#e2e8f0", fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "48px 24px", textAlign: "center" }}>
        ...
        <p style={{ color: "#94a3b8", marginBottom: 32 }}>
          Install LinkShield to see the full privacy report for this site.
        </p>
        ...
        <a href="https://chrome.google.com/webstore" style={{
          ...
          Install LinkShield to See Full Report
        </a>

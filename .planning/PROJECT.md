...
Cleanway — самая удобная защита от мошеннических ссылок для **обычных людей**: родителей, бабушек, детей, не-техспецов по всему миру. Работает автоматически, говорит понятным языком, не требует знаний. Спасает обычных людей от цифрового мошенничества — тысячи, потом миллионы.
...
Если утечёт — атакующий узнает что человек пользуется Cleanway. И всё.
...
- **ML:** CatBoost (27 features, AUC 0.95 — calibrated baseline from data/model_meta.json), hosted bloom filter

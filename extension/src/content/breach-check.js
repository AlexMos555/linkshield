...
async function checkEmailBreach(email) {
  ...
  try {
    var resp = await fetch((typeof window !== "undefined" && window.CLEANWAY_API_BASE ? window.CLEANWAY_API_BASE : "https://web-production-fe08.up.railway.app") + "/api/v1/breach/check/" + prefix);

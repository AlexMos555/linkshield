...
> ⏸️ **#2 + #3 (календарные events) и #4 (Anthropic key rotation) отложены по запросу 29 июня. Напомнить when подойдёт неделя CWS submit (ориентир: понедельник 2026-06-30).**

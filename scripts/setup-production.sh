...
echo ""
echo "  🛡️  LinkShield Production Setup"
echo "  ════════════════════════════════"
echo ""
...
echo "  supabase projects create linkshield --org-id YOUR_ORG_ID --db-password YOUR_PASSWORD --region us-east-1"
echo ""
echo "Option B: Create at https://supabase.com/dashboard"
echo "  → New Project → name: linkshield → generate password → create"
echo ""
...
ALLOWED_ORIGINS=https://linkshield.io,https://linkshield.vercel.app
EOF

echo "Created .env file"
echo ""
echo "Deploying to Railway..."
railway init --name linkshield-api 2>/dev/null || true
railway up --detach
...
echo ""
read -p "Enter Railway API URL (e.g., https://linkshield-api.up.railway.app): " API_URL
...
echo ""
read -p "Enter Vercel URL (e.g., https://linkshield.vercel.app): " LANDING_URL
...
zip -rq ../linkshield-extension.zip . -x "*.md"
cd ..
echo "Extension rebuilt: linkshield-extension.zip"
...
echo "  Extension: Upload linkshield-extension.zip to Chrome Web Store"
echo ""
echo "  Next steps:"
...
echo "  4. Buy domain linkshield.io and point to Vercel"
echo "═══════════════════════════════════════════"
